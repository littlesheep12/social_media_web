# Generated by Django 4.1 on 2023-09-01 01:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('male', 'Male'), ('femail', 'Female')], default='male', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relationship', models.CharField(choices=[('single', 'Single'), ('married', 'married'), ('inlove', 'In Love')], default='single', max_length=256)),
                ...
                ('working_at', models.CharField(blank=True, max_length=256, null=True)),
                ...
                ('slug', models.SlugField(blank=True, default='default-slug', null=True, unique=True)),
                ('blacked', models.ManyToManyField(blank=True, related_name='blacked', to=settings.AUTH_USER_MODEL)),
